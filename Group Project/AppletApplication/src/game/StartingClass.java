...
public class StartingClass extends Applet implements Runnable, KeyListener {
	...
	enum GameState {
		Running, Dead, success
	}

	GameState state = GameState.Running;

	private static Robot robot;
	public static Heliboy hb, hb2, hb3, hb4, hb5, hb6;
	...
	public void init() {
		...
		AudioClip audioClip=getAudioClip(base,"data/yosakura.wav");
	...
	public void start() {
		...
		hb3 = new Heliboy(1340, 360);
		hb4 = new Heliboy(1700, 360);
		hb5 = new Heliboy(3340, 360);
		hb6 = new Heliboy(4700, 360);
	...
	public void paint(Graphics g) {
		...
		g.fillRect(0, 0, 800, 480);
		g.setColor(Color.WHITE);
		g.drawString("Congratulation!!", 360, 240);
